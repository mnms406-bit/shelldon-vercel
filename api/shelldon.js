...
export default async function handler(req, res) {
  // ✅ Allow your Shopify theme frontend
        ...
        messages: [
          {
            role: "system",
            content: `
You are Shelldon, the virtual assistant for the Shopify store at http://51294e-8f.myshopify.com.
Only answer questions related to the store's products, collections, and pages.
`
          },
          {
            role: "user",
